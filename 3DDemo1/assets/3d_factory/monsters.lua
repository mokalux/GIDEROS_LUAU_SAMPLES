...
function Monsters:init(xworld, xcamera, xparams)
	-- the params
	...
	self.camera = xcamera
	-- the mesh
	local xfilemesh = "models/monsters/Yeti_mesh.json"
	local xfileanims = "models/monsters/Yeti_anims.json"
...
-- GAME LOOP
function Monsters:onEnterFrame(e)
	-- move player
	local matrix = self.body:getTransform()
