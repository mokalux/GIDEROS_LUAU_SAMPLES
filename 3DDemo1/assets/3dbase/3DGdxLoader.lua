...
function loadGdx(file,imtls) -- XXX
	local mtls=imtls or {}
...
--			elseif a=="TEXCOORD1" then as=2 an="t" -- XXX
--			elseif a=="TEXCOORD2" then as=2 an="t" -- XXX
--			elseif a=="TEXCOORD3" then as=2 an="t" -- XXX
--			elseif a=="TEXCOORD4" then as=2 an="t" -- XXX
--			elseif a=="TEXCOORD5" then as=2 an="t" -- XXX
--			elseif a=="TEXCOORD6" then as=2 an="t" -- XXX
--			elseif a=="TEXCOORD7" then as=2 an="t" -- XXX
--			elseif a:sub(1,8)=="TEXCOORD" then as=2 an="t"..a:sub(9,9)
