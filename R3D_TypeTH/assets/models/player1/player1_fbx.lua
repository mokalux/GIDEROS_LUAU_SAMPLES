...
--	self.m=buildGdx("models/fantasy_female/characterLargeFemale.json", { modelpath = "models/fantasy_female/" } )
	...
	self.body:setAngularLockAxisFactor(0, 1, 0)
--	self.body:setAngularDamping(0.99) -- 0.99 play with it!
--	self.body:setLinearDamping(0.99) -- 0.99 play with it!
	-- the shape
	self.shape = r3d.BoxShape.new(width/4, height/2, depth*2)
--	self.shape = r3d.CapsuleShape.new(width/5, height/2+0.5) -- radius, height
	...
	mat.bounciness = 0.5
	mat.frictionCoefficient = 0.9 -- 0.01 0.5 0.01
